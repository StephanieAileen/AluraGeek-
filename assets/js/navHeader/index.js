...
export function nav(paths) {
  ...
  ${
    paths.login &&
    `<div class="navHeader__login"><a href="${paths.login}" class="btn__login">Login</a><img class="lupa__hidden" src="${paths.lupa}" alt="imagem de uma lupa" data-input/></div><input type="text" class="lupa__hidden--input" placeholder="¿Qué deseas buscar?"/>`
  }
  `;
...
export function footer(paths) {
  ...
  <p>Alura Latam - Challenge Alura Geek</p>
  </div>
  `;
